...
Background.prototype._setColorCode = function (code) {
...
Background.prototype.rest = function () {
...
Background.prototype.hex = function (color) {
  return this.rgb(hex(color));
};
