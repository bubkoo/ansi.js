...
var newlineEvent = require('./newline');
...
Cursor.prototype.save = function (withAttributes) {
  return this._write(withAttributes ? codes.saveCursor : codes.savePosition);
};

Cursor.prototype.restore = function (withAttributes) {
  return this._write(withAttributes ? codes.restoreCursor : codes.restorePosition);
};

Cursor.prototype.reset = function () {

  this._write(prefix + 0 + suffix);
